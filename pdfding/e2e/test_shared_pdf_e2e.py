...
class NoSharedPdfE2ETestCase(PdfDingE2ETestCase):
    ...
    def test_share_pdf(self):
        Pdf.objects.create(collection=self.user.profile.current_collection, name='some_pdf')
        ...
        with sync_playwright() as p:
            ...
            expect(self.page.locator("#shared-obj-link-1")).to_contain_text("some_shared_pdf")
...
class SharedPdfE2ETestCase(PdfDingE2ETestCase):
    ...
    def test_sort(self):
        ...
        with sync_playwright() as p:
            ...
            expect(self.page.locator("#shared-obj-link-3")).to_have_text("PDF is shared")
    ...
    def test_delete(self):
        ...
        with sync_playwright() as p:
            ...
            expect(self.page.locator("#shared-obj-link-1")).to_have_text("some_shared_pdf")
